...
function checkInteractionVectors() {
    ...
    $.post(`${bkndUrl}/db/insertEvents`, {obj: trackingObjString}, () => console.log('insert done'));
    $.post(`${bkndUrl}/db/getFormatCurrentSession`, {obj: trackingObjString}, (data, status) => {
        $("#your_session").text(JSON.stringify(data, undefined, 2));
    });
    $.post(`${bkndUrl}/db/getMatchingSessions`, {obj: trackingObjString}, (data, status) => {
